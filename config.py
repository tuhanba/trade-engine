...
MAX_PORTFOLIO_EXPOSURE_PCT = _env_float("MAX_PORTFOLIO_EXPOSURE_PCT", 80.0)
...
MAX_COINS_PER_SCAN_LOOP  = _env_int("MAX_COINS_PER_SCAN_LOOP", 20)
MAX_DAILY_SIGNALS        = _env_int("MAX_DAILY_SIGNALS", 40)

# Sinyal Esikleri
DATA_THRESHOLD      = _env_float("DATA_THRESHOLD", 55.0)
WATCHLIST_THRESHOLD = _env_float("WATCHLIST_THRESHOLD", 60.0)
TELEGRAM_THRESHOLD  = _env_float("TELEGRAM_THRESHOLD", 65.0)
TRADE_THRESHOLD     = _env_float("TRADE_THRESHOLD", 72.0)
...
PAPER_TRACK_HORIZON_HOURS       = _env_float("PAPER_TRACK_HORIZON_HOURS", 4.0)

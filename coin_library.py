...
_COIN_PARAMS: dict[str, dict] = {
    ...
    "AVAXUSDT": {**_TEMPLATES["dangerous"], "volatility_profile": "dangerous"},  # Backtest: WR=12.5%, PnL=-$48,
    ...
    "SUIUSDT":  {**_TEMPLATES["dangerous"], "volatility_profile": "dangerous"},  # Backtest: WR=18.2%, PnL=-$55,
